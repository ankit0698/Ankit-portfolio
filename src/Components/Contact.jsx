...
function Contact() {
  ...
  return (
    <section
      id="contact"
      className="container min-h-screen mx-auto flex flex-wrap px-10 py-20  md:flex-row flex-col "
    >
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        >
          ...
          <p className="leading-relaxed mb-5">
            Thank you for considering me for your project or team. Please fill
            out the form below to provide me your requirements.
          </p>
