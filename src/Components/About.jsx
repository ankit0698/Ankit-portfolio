function About() {
  return (
    <>
      <div
        id="about"
        className=" flex px-10 lg:mt-2 pt-12 bg-[url('/bg-image.svg')] min-h-screen md:bg-none  bg-cover  md:flex-row flex-col items-center overflow-x-hidden "
      >
        ...
        <div className=" md:w-5/6   -mt-64 -mr-[280px] ">
          <img
