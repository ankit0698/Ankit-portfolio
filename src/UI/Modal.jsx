...
const Modal = ({ open }) => {
      ...
      return (
            ...
            createPortal(<dialog className={classes.modal} ref={dialog} >
                  ...
                  <div className={classes.item}>
                        ...
                        <h2>
                              <a className={classes.link} target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/ankit-mishra-a0874619a">Click to find</a>
                        </h2>
                  </div>
                  <div className={classes.item}>
                        <img src={gitImage} alt='nothing' />
                        <h2>
                              <a className={classes.link} target="_blank" rel="noreferrer" href="https://github.com/ankit0698">Click to find</a>
                        </h2>
                  </div>
                  <div className={classes.item}>
